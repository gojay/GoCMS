...
FCKConfig.ToolbarSets["ZF"] = [
	['Undo','Redo','-','Cut','Copy','Paste','PasteText','PasteWord','-','Bold','Italic','Underline','TextColor'],
	['OrderedList','UnorderedList', 'JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','-','Image','Flash','Smiley'],
	['RemoveFormat','FontFormat','FontName','FontSize','-','DrupalBreak','Preview','Source']
] ;
