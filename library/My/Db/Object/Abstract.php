...
abstract class My_Db_Object_Abstract
{
	...
	protected function _generateSlug( $title, $col = 'content_slug', $separator = '-' )
	{
        ...
        // find similar slugs
        $query = sprintf("select %s from %s where %s like ?", $col, $this->_table, $col );
